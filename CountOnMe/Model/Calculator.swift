...
func tappedEqual() {
    if expressionIsCorrect {
        ...
        NotificationCenter.default.post(Notification(name: Notification.Name("error"), userInfo: ["message":"Entrez une expression correcte !"]))
    }
    
    if expressionHaveEnoughElement {
        processCalcul()
    } else {
        NotificationCenter.default.post(Notification(name: Notification.Name("error"), userInfo: ["message":"Démarrez un nouveau calcul !!!"]))
    }
}
